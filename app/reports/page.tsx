...
export default function ReportsPage() {
  ...
  // Experiment filter options are derived from the reports actually present.
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          {rep.status === "ready" && (
                            <button
                              className="p-1.5 text-ink-faint hover:text-ink hover:bg-surface-elevated transition-colors"
